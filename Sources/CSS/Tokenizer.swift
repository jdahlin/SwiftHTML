...
func consumeStringToken(_ tokenizer: inout Tokenizer, endingCodePoint: Codepoint? = nil) throws -> Token {
...
func consumeURLToken(_ tokenizer: inout Tokenizer) throws -> Token {
...
func checkIfTwoCodePointsAreAValidEscape(c1: Codepoint, c2: Codepoint) -> Bool {
    // If the first code point is not U+005C REVERSE SOLIDUS (\), return false.
    if c1 != "\\" {
        return false
    }
...
func consumeIdentSequence(_ tokenizer: inout Tokenizer) throws -> String {
...
func consumeNumber(_ tokenizer: inout Tokenizer) throws -> Number {
...
func consumeBadURLRemnants(_ tokenizer: inout Tokenizer) throws {
    // Repeatedly consume the next input code point from the stream:
    repeat {
        switch tokenizer.peek() {
